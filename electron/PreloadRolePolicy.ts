...
const RENDERER_API_KEYS = new Set([
  ...
  'cropperConfirmed', 'deleteOpenAICompatibleEndpoint', 'dismissDynamicAction', 'downloadUpdate', 'endMeeting', 'endTrialByok',
  'fetchOpenAICompatibleModels', 'fetchProviderModels', 'fileExists', 'forceRestartOllama', 'generateBrainstorm', 'generateClarify',
  ...
  'getGroqFastTextMode', 'getOpenAICompatibleEndpoints', 'getThinkingEffort',
  ...
  'restartAndInstall', 'saveCustomProvider', 'saveOpenAICompatibleEndpoint', 'saveScreenshotFile', 'seedDemo', 'selectServiceAccount', 'setActionButtonMode',
  ...
  'setGroqFastTextMode', 'setGroqSttApiKey', 'setIbmWatsonApiKey', 'setKeybind', 'setMeetingInterfaceTheme', 'setMeetingRetention',
  ...
  'setSttProvider', 'setTavilyApiKey', 'setThemeMode', 'setThinkingEffort', 'setUndetectable', 'setVerboseLogging',
  ...
  'testLlmConnection', 'testOpenAICompatibleEndpoint', 'testReleaseFetch', 'testSttConnection', 'toggleModelSelector', 'toggleOverlayExpand',
