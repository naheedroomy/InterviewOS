...
import answercueLogo from "./icon.png";
...
const AnswerCueInterfaceCard = ({ className = "", isMobile = false, isStatic = false, hidePill = false, hideMessages = false, dreamyVariant = false, spreadHotkeys = false }: Props) => {
        ...
        >
          ...
          {!hideMessages && (
            <div className="px-4 pt-4 pb-2 flex justify-end">
              <div className="relative px-4 py-2 rounded-full text-white text-[13px] font-semibold shadow-[0_8px_20px_rgba(124,77,255,0.30)] border border-white/20"
                style={{ background: "linear-gradient(160deg, #1769ff 0%, #7c4dff 55%, #e76bce 100%)" }}>
          ...
          <div className="px-3 pb-[11px] pt-[7px]">
            ...
            <div className="flex items-center justify-between mt-[7px] px-[1px]">
              ...
              <button className="w-[26px] h-[26px] rounded-full flex items-center justify-center relative overflow-hidden border border-white/20"
                style={{ background: "linear-gradient(160deg, #1769ff 0%, #7c4dff 55%, #e76bce 100%)", boxShadow: "0 8px 20px rgba(124,77,255,0.30)" }}>
...
export default AnswerCueInterfaceCard;
