...
export const TrialPromoToaster: React.FC<Props> = ({
  isOpen, hasAnswerCueKey, hasTrialToken, onDismiss, onStartTrial, onManualSetup,
}) => {
  ...
  useEffect(() => {
    ...
    if (hasAnswerCueKey || hasTrialToken) return;
  ...
  }, [isOpen, hasAnswerCueKey, hasTrialToken]);
              ...
              <motion.div variants={STAGGER} initial="hidden" animate="show" style={{ display: 'flex', flexDirection: 'column', gap: '22px' }}>
                ...
                <motion.div variants={ITEM} style={{ textAlign: 'center' }}>
                  ...
                  <p style={{ fontSize: '13px', lineHeight: 1.66, color: T.t3, margin: '0 auto', maxWidth: '330px' }}>
                    Full InterviewOS API access — AI chat, meeting transcription, and company research — free for 30 minutes. Bound to this device. No sign-in.
                  </p>
                </motion.div>
