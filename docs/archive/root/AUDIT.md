# AnswerCue API Audit — 2026-05-04

Server lives in `answercue-api/` (single ~6k-line `server.js` + `lib/queryClassifier.js`). Submodule with public remote `github.com/FarzamHejaziK/answercue-api`. All path:line refs are inside `answercue-api/`.
