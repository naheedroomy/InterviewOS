...
This policy describes the current InterviewOS desktop app behavior.

## Short Version

InterviewOS is designed to keep interview data on your device by default.
...
- InterviewOS does not sell user data.

## Data Stored Locally

InterviewOS may store the following on your device:
...
When you ask InterviewOS to generate an answer, prep response, post-interview response, or help response, relevant prompt context may be sent to the selected provider.
